...
internal class DefaultWorkspaceConfigTest {
    ...
    fun `workspace config test`() {
        ...
        expectThat(workspace.metadata.id) isEqualTo 553
        expectThat(workspace.metadata.environmentId) isEqualTo 1105
        ...
        expectThat(workspace.getExperimentOrNull(5))
            ...
            .hasOverrides()
            .and {
                get { variations }.hasSize(2)
                get { variations[0].id } isEqualTo 13378
                get { variations[0].key } isEqualTo "A"
                get { variations[0].isDropped }.isFalse()
                get { variations[0].parameterConfiguration }.isNotNull().get { id } isEqualTo 1L
                get { variations[1] } isEqualTo Variation(13379, "B", false, null)
            }
        ...
        expectThat(workspace.getExperimentOrNull(5)?.getVariationOrNull("A")?.parameterConfiguration)
            .isNotNull()
            .and {
                get { id } isEqualTo 1
                get { parameters }.and {
    ...
    private fun Assertion.Builder<ExperimentConfig>.identifier(id: Long, key: Long, type: Experiment.Type) =
        compose("Experiment") {
    ...
    private fun Assertion.Builder<ExperimentConfig>.hasVariations(vararg variations: Variation) =
    ...
    private fun Assertion.Builder<ExperimentConfig>.hasOverrides(vararg overrides: Pair<String, Long>) =
