...
class PollingWorkspaceConfigManagerTest {

    @RelaxedMockK
    private lateinit var httpWorkspaceFetcher: WorkspaceConfigFetcher

    private fun sut(
        httpWorkspaceFetcher: WorkspaceConfigFetcher = this.httpWorkspaceFetcher,
