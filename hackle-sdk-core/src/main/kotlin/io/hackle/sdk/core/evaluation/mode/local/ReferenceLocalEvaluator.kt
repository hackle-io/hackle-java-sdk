...
abstract class ReferenceLocalEvaluator<REFERENCE : ConfigEntity, EVALUATION : Evaluation> {
    fun evaluate(parentRequest: LocalEvaluateRequest, context: Evaluator.Context, reference: REFERENCE): EVALUATION {
        ...
        return doEvaluate(parentRequest, context, reference)
            .also { context.add(it) }
    }
