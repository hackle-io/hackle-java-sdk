...
internal class SegmentConditionMatcher(
    ...
    private fun matches(request: LocalEvaluateRequest, context: Evaluator.Context, value: Any): Boolean {
...
internal class SegmentMatcher(
    ...
    fun matches(request: LocalEvaluateRequest, context: Evaluator.Context, segment: Segment): Boolean {
        return segment.targets.any { matches(request, context, it) }
    }

    private fun matches(request: LocalEvaluateRequest, context: Evaluator.Context, target: Target): Boolean {
