...
internal abstract class ExperimentContextualEvaluator internal constructor(
    ...
    abstract fun decorate(request: Evaluator.Request, context: Evaluator.Context, evaluation: Evaluator.Evaluation): ExperimentEvaluation
    ...
    private fun evaluateInternal(request: Evaluator.Request, context: Evaluator.Context, experiment: Experiment): ExperimentEvaluation {
